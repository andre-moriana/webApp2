...
document.addEventListener('DOMContentLoaded', function() {
    ...
    /** Clé JSON des réponses : id question si présent, sinon index (aligné avec l'API sans id explicite). */
            ...
            form.questions.forEach(function(question, index) {
                ...
                if (question.type === 'text') {
                    ...
                    question.options.forEach(function(option, optIdx) {
                        const inputId = 'fq_r_' + index + '_' + optIdx;
                        formHtml += `
                    ...
                    question.options.forEach(function(option, optIdx) {
                        const inputId = 'fq_c_' + index + '_' + optIdx;
                        formHtml += `
                            <div class="form-check">
    ...
    window.submitFormResponse = function() {
        ...
        // Vérifier les champs obligatoires (clés = id ou index, cohérent avec openFormModal)
            ...
            if (form && form.questions && Array.isArray(form.questions)) {
                ...
                form.questions.forEach(function(question, questionIndex) {
                    ...
                    responses.forEach(function(response) {
                        ...
                        // Chercher la réponse pour cette question (clé stable id ou index, puis anciens formats)
                        let answer = null;
