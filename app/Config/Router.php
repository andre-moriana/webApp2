...
class Router {
    ...
    private function defineRoutes() {
        ...
        $this->addRoute("GET", "/api/concours/{id}/greffes", "ApiController@proxyConcoursGreffes");
        $this->addRoute("POST", "/api/concours/{id}/greffes", "ApiController@proxyConcoursGreffesCreate");
