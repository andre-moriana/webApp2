...
class Router {
    ...
    private function defineRoutes() {
        ...
        $this->addRoute("POST", "/score-sheet/export-to-concours", "ScoreSheetController@exportToConcours");
        ...
        // Route sans /api/ (comme le chat) pour <img src=...>
        ...
        $this->addRoute("PUT", "/api/concours/{id}/peloton-rules", "ApiController@proxyConcoursPelotonRules");
        ...
        $this->addRoute("GET", "/api/concours/{id}/buvette/reservations/inscription/{inscriptionId}", "ApiController@proxyConcoursBuvetteReservationsByInscription");
