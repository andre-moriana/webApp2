            ...
            <?php if (!empty($showFacebookPagePlugin) && $fbHref !== ''): ?>
                <?php if (!empty($facebookAppId)): ?>
                    ...
                    <script async defer crossorigin="anonymous"
                            src="https://connect.facebook.net/fr_FR/sdk.js#xfbml=1&version=v25.0&appId=<?php echo htmlspecialchars($facebookAppId); ?>"></script>
                <?php endif; ?>
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body text-center py-4">
                        <h2 class="h5 mb-3">Actualités de <strong><?php echo htmlspecialchars($clubName); ?></strong> sur Facebook</h2>
                        <p class="text-muted mb-3">
                            Le fil ci‑dessous est chargé depuis Facebook via le plugin officiel (SDK JavaScript).
                        </p>
                        <div class="d-flex justify-content-center mb-3">
                            <div class="fb-page"
                                ...
                                <blockquote cite="<?php echo htmlspecialchars($fbHref); ?>" class="fb-xfbml-parse-ignore">
                                    <a href="<?php echo htmlspecialchars($fbHref); ?>"><?php echo htmlspecialchars($clubName); ?></a>
                                </blockquote>
                            </div>
                        </div>
                        <p class="text-muted small mb-0">
                            Si le fil ne s'affiche pas, ouvrez la page :
