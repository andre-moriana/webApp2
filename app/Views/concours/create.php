...
<form method="post" action="<?= isset($concours) ? '/concours/update/' . $concours->id : '/concours/store' ?>" id="concoursForm" novalidate
    ...
    <div class="form-section">
        ...
        <div class="form-group">
            ...
            <textarea name="informations" id="informations" class="form-control" rows="4" placeholder="Informations complémentaires affichées sur la page détail du concours (optionnel)"><?= htmlspecialchars(isset($concours) ? ($concours->informations ?? $concours['informations'] ?? '') : '') ?></textarea>
        </div>
        ...
        <div class="form-group tarifications-section" style="margin-top: 20px;">
            <h4>Tarification</h4>
            <p class="text-muted small">Tarifs d'inscription selon l'age et le numero de tir.</p>
            <div class="table-responsive">
